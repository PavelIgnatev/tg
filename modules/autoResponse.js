...
async function getOffer(groupId) {
  ...
  const {
    offer: {
      ...
      goal = "Получить согласие на зум встречу с старшим менеджером, который расскажет про продукт и подготовит для вас новогодний подарок, если согласие получено, то ты передашь контакт Telegram пользователя менеджеру и он напишет в течении 24 часов.",
    },
