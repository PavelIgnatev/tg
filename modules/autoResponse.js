...
Просто напиши слово "Хорошо", если понял свою роль. ничего больше.`,
    `Имя клиента: ${userName}. Переписка с клиентом до этого момента: ${result.join(
      "\n"
    )}; Максимальная длина ответа: 200 символов, пожалуйста, ограничься не более 200 символами. придумай ответ даже в том случае, если данных о переписке недостаточно`,
  ];
